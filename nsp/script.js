document.addEventListener("DOMContentLoaded", () => {
    ...
    audio.src = "https://files.catbox.moe/pl1u3x.mp3" // audio file
    audio.volume = 1.0
    ...
    function shareStation() {
      const shareText = `I'm listening to ${playlist[currentTrackIndex].title} by ${playlist[currentTrackIndex].artist} on Non Stop Pop FM! Check it out at https://joymura.lol/nsp `
